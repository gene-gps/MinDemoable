...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *GloProxSys.MDPApp*):

Restore dependencies
```
    cd "GloProxSys.MDPApp"
    dotnet restore
```

Execute unit tests
```
    cd "GloProxSys.MDPApp/test/GloProxSys.MDPApp.Tests"
    dotnet test
```

Deploy application
```
    cd "GloProxSys.MDPApp/src/GloProxSys.MDPApp"
